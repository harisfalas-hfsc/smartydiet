      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col items-center gap-3">
          <div className="flex items-center gap-4">
            <a href="https://www.facebook.com/share/1F2hBHPpUj/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={socialClass}>
            ...
            <a href="https://www.tiktok.com/@smarty.diet?_r=1&_t=ZN-99obv8i8ewg" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className={socialClass}>
