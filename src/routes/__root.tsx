...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SmartyDiet — Smart nutrition, personalized diets & tracking tools" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "SmartyDiet — Smart nutrition, personalized diets & tracking tools" },
      {
        ...
        content:
          "Pre-built diets, a personal diet builder, nutrition articles and tracking tools. Part of the Smarty family.",
      },
      ...
      { property: "og:image", content: "https://smartywellness.com/__l5e/assets-v1/198b5c22-0079-4159-a860-f59dd2522260/smartydiet-social.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "SmartyDiet — Smart nutrition, personalized diets & tracking tools" },
      { name: "twitter:image", content: "https://smartywellness.com/__l5e/assets-v1/198b5c22-0079-4159-a860-f59dd2522260/smartydiet-social.png" },
    ],
