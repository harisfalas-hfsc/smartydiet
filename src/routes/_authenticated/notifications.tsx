...
export const Route = createFileRoute("/_authenticated/notifications")({
  head: () => ({
    meta: [
      { title: "Notifications — SmartyDiet" },
      {
        name: "description",
        content: "Read, mark and delete your SmartyDiet billing and plan messages.",
      },
...
function NotificationsPage() {
  ...
  function openMessage(n: AppNotification) {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-8 sm:py-12 lg:max-w-4xl lg:px-8 lg:py-16">
      <div className="mb-5">
        <p className="text-xs font-bold uppercase tracking-widest text-primary">Inbox</p>
        <h1 className="text-2xl font-extrabold tracking-tight sm:text-3xl">Notifications</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Payment and renewal updates. Tap a message to read it, select to delete.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <p className="rounded-2xl border border-border p-8 text-center text-sm text-muted-foreground">
          Nothing here yet. Renewal reminders and payment updates land here.
        </p>
      ) : (
