    ...
    <SeoLanding
      ...
      sections={[
        ...
        },
        {
          ...
          body: "You get the daily calorie and macro targets, a full meal-by-meal menu for 1 or 2 weeks at the meal frequency you chose, portion sizes in grams, a weekly grocery list, and every allergen or disliked food removed. One refinement is included so the plan can be adjusted once you have real-world feedback.",
        },
      ]}
      faqs={FAQS}
      related={[
